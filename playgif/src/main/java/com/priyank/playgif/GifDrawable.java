...
import com.priyank.playgif.transforms.CornerRadiusTransform;
import com.priyank.playgif.transforms.Transform;
...
import static com.priyank.playgif.InvalidationHandler.MSG_TYPE_INVALIDATION;
...
public class GifDrawable extends Drawable implements Animatable, MediaPlayerControl {
	...
	public static GifDrawable createFromResource(@NonNull Resources res, @RawRes int resourceId) {
		try {
